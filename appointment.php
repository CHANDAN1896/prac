...
Sports Academy.
    ...
    if(!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
     ...
     if(mysqli_num_rows($select)) {
        exit('<h2> Your appointment has already booked!</h2><br> <h4> We have Sent you an confirmation email on your registered email. <center><div><p id="pay" class="gam"  ><b><a href="sports.html" onclick="history.go(-1)" style="text-decoration: none; color: rgb(5, 12, 18);"> Go Back</a></b> </p> </div></center>
        ');
